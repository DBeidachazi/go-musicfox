# Copied verbatim from folia-major electron/analysis/htdemucs_runner.py @ d2b84674 (AGPL-3.0,
# https://github.com/chthollyphile/folia-major). go-musicfox writes this file next to the
# models and runs it with the downloaded runtime or automixPython; see stems.go.
